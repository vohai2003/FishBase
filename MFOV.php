...
<body>
<h1 style='text-align:center;'>MFOV:Tìm kiếm</h1>
...
if ($result1->num_rows > 0) {
  while ($row = $result1->fetch_assoc()) {
       echo "<tr><td><a href='details.php?db=MFOV&id=".$row["Loai_ID"]."'><div>". $row["TenVN"]. "</div></a></td><td>". $row["TenKH"]. "</td><td>". $row["TenEnglish"]. "</td></tr>";
       }
	   echo "</table>";
}
}
