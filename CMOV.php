...
<body>
<h1 style='text-align:center;'>Nhuyễn thể Việt Nam (CMOV) :Tìm kiếm</h1>
...
if ($result1->num_rows > 0) {
  while ($row = $result1->fetch_assoc()) {
       echo "<tr><td><a href='details.php?db=CMOV&id=".$row["Loai_ID"]."'><div>". $row["TenVN"]. "</div></a></td><td><a href='details.php?db=CMOV&id=".$row["Loai_ID"]."'><div>". $row["TenKH"]. "</div></a></td><td><a href='details.php?db=CMOV&id=".$row["Loai_ID"]."'><div>". $row["TenEnglish"]. "</div></a></td></tr>";
       }
	   echo "</table>";
}
}
